...
CREATE TABLE `ll_landing_page_order` (
  ...
  `status` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '''CHƯA XỬ LÝ'', ''THÀNH CÔNG'', ''HỦY BỎ''',
...
-- Dump completed on 2022-05-23  0:31:04
